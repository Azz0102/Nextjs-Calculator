        ...
        <div className='nav'>
            <div
                ...
                <div className='flex items-center h-full max-w-[1380px] mx-auto my-0'>
                    ...
                    {/*navigation_menu*/}
                    <div className='opacity-100 float-left flex-1 flex items-center pl-10 pr-0 py-0'>
                        <ul className='list-none'>
                            {/*product dropdown*/}
                            <ProductDropdown isToggle={isToggle} setIsToggle={setIsToggle}/>
                            <li className='relative inline-block mr-[35px]'>
                                <a href='/'
                            ...
                            <li className='cursor-pointer text-[17px] tracking-[-0.2px] relative inline-block mr-[35px] font-[opensansregular]'>
                    ...
                    <div className='inline-flex justify-end'>
                        <div className='relative h-[60px] items-center flex'>
                            {/*search*/}
                            <div className='inline-flex items-center relative px-[15px] py-[26px]'>
                                <span className='inline-block w-[18px] leading-none cursor-pointer' onClick={() => {
                                   ...
                                   <svg id="search-icon-svg" className={`${isToggle === '3' ? 'hidden' : 'block'}`} viewBox="0 0 35 32.3">
                                    ...
                                    <svg id="close-icon-svg" data-name="Layer 3" viewBox="0 0 22 21.77"
                                ...
                                ${isToggle === '3' ? 'opacity-100 visible translate-y-[85px]' : 'opacity-0 invisible translate-y-[65px]'}`}>
                                    <div className='flex justify-center w-full z-[1] relative bg-white'>
                            ...
                            <div className={`inline-flex items-center relative px-[15px] py-[26px] max-[820px]:px-2.5 max-[820px]:py-[26px]
                                ...
                                after:border-b-[color:var(--bg-color)] after:content-[""] after:absolute after:w-0 after:h-0 after:transition-opacity after:duration-[0.4s] after:ease-[ease] after:border-b-8 after:border-x-8 after:border-x-transparent after:border-solid after:right-3.5 after:top-auto after:-bottom-1 after:box-border max-[820px]:after:bottom-[4px] before:box-border ${isToggle
                                                                                                                                                                                                                                                                                                                                                                  === '4' ?
                                'before:opacity-100 after:opacity-100' : 'before:opacity-0 after:opacity-0'}`}>
                                ...
                                <div
                                    className={`fixed w-full h-full rounded-[0_0_5px_5px] left-0 top-[75px] custom-backdrop max-[820px]:top-[60px] ${isToggle
                                                                                                                                                     === '4' ?
                                        'opacity-100'
                                        + ' visible'
                                        ...
                                        <div className='w-full relative max-w-[1330px] mx-auto my-0 px-0 py-[60px] max-[1390px]:max-w-[95%]'>
                                            <div>
                                                <div className='flex max-[1023px]:flex-wrap max-[1023px]:justify-center'>
                                                    <div
                                                        className='flex bg-white border [flex-flow:column] min-h-[355px] cursor-pointer relative overflow-visible w-3/12 transition-all duration-[0.8s] ease-[ease] mr-3 p-0 rounded-[3px] border-solid border-[#e7ebf0]'>
                                                        <div
                                                    ...
                                                    <div
                                                        className='flex bg-white border flex-col min-h-[355px] cursor-pointer relative overflow-visible w-3/12 transition-all duration-[0.8s] ease-[ease] mr-3 p-2.5 rounded-[3px] border-solid border-[#e7ebf0]'>
                                                        <div
                                                            ...
                                                            <p className='w-[88%] text-sm text-[color:var(--secondary-color)] leading-[1.7] tracking-[-0.2px] mx-auto my-0 font-[opensansregular]'>Zoho
                                                                Mail là nền tảng email bảo mật và mạnh mẽ dành cho các nhóm thuộc mọi quy mô. Dễ dàng
                                                            ...
                                                            <div className='relative w-[92%] -right-6 -bottom-10'>
                                                                <img
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div className='w-[94%] absolute right-1.5 -bottom-1.5'>
                                                                <img
                                                    ...
                                                    <div
                                                        className='flex bg-white border flex-col min-h-[355px] cursor-pointer relative overflow-visible w-3/12 transition-all duration-[0.8s] ease-[ease] p-2.5 rounded-[3px] border-solid border-[#e7ebf0]'>
                                                        <div
                                                            ...
                                                            <div className='absolute w-[85%] right-[7.5%] bottom-0'><img className='max-w-full h-auto'
